...
>
> ⚠️ **2026년 7월 민선9기 조직개편 주의**: 미래산업국→미래산업본부 격상 및 일부 과 재편으로, [추정한 실무 관행] 항목의 실제 담당 부서명은 `[공문서대조필요]` 상태입니다. 행정기구 설치조례 개정 전후표·사무분장표로 확인 바랍니다.
...
- **검토자**: 담당 팀장
- **결정자**: 담당 과장 (예: 바이오과장, 청년정책담당관 등) — ⚠️ 과 명칭은 2026년 7월 개편 후 기준 `[공문서대조필요]`
- **반려/실패 사유**: 근거법령 부재, 시정 방향 불일치, 명확한 수혜 대상 미설정

### 2단계: 주관부서 자체 검토 & 내부방침 수립
- **구분**: [공식 절차] & [추정한 실무 관행]
- **입력문서**: 사업기획서(안), 내부 방침서(시장/부시장/본부장 결재)
- **작성자**: 담당 주무관
- **검토자**: 팀장 및 과장
- **결정자**: 담당 본부장 (미래산업본부장 등) 또는 정무/행정부시장 — ⚠️ 구 미래산업국장→미래산업본부장으로 위계 변경, `[공문서대조필요]` 결재선 원문 확인 필요
- **반려/실패 사유**: 재정 부담 과다, 추진 필요성 소명 부족, 유사한 기존사업 존재
- **[추정한 실무 관행]** → 민선9기 조직개편 이후 변경 여부: `[공문서대조필요]`
...
- **작성자**: 주관 부서 주무관
- **결정자**: 담당 본부장 및 예산담당관 — ⚠️ 구 국장→본부장 위계 변경, `[공문서대조필요]`
...
|---|---|---|---|
| **시청 주관부서** | 미래산업본부/청년정책 주무관 | 바이오과장, 청년정책담당관 | 미래산업본부장, 기획조정실장 |
| **수행기관** | 인천테크노파크(ITP) 전담PD | ITP 센터장, 책임연구원 | 인천테크노파크 원장 |
| **시의회** | 상임위 전문위원 | 예결위 심사위원 | 산업경제위원장, 의장 |

> ⚠️ 위 부서명 중 미래산업본부 산하 세부 과(바이오과 등)는 `[공문서대조필요]` — 행정기구 설치조례 사무분장표 원문으로 최종 확인 필요
